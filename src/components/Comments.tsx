      ...
      <div className="space-y-6">
        {loading ? (
          ...
          comments.map((comment) => (
            <div key={comment.id} className={`bg-gray-900/40 p-5 rounded-xl border shadow-md transition-all duration-500 ${comment.isFirst ? "border-yellow-600/50 shadow-[0_4px_15px_rgba(234,179,8,0.1)] bg-gradient-to-br from-gray-900/40 to-yellow-900/10" : "border-gray-800/60"}`}>
